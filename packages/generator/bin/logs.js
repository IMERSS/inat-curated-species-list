...
var initLogger = function (temporaryFolder) {
    ...
    return (0, winston_1.createLogger)({
        ...
        transports: [new winston_1.transports.File({ filename: 'data.log', level: 'info', dirname: temporaryFolder })],
    });
};
exports.initLogger = initLogger;
var logPacket = function (packetNum, tempFolder, resp) {
    fs_1.default.mkdirSync(tempFolder, { recursive: true });
    fs_1.default.writeFileSync(path_1.default.resolve(tempFolder, "packet-".concat(packetNum, ".json")), JSON.stringify(resp, null, '\t'), 'utf-8');
};
